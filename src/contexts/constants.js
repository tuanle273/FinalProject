export const apiUrl =
  process.env.NODE_ENV !== "production"
    ...
    : "https://server2-vxcz.onrender.com/api";
...
export const BOOKING_LOAD_FAIL = "BOOKING_LOAD_FAIL";
export const BOOKING_LOAD_SUCCESS = "BOOKING_LOAD_SUCCESS";
export const BOOKING_LOAD_REQUEST = "BOOKING_LOAD_REQUEST";
